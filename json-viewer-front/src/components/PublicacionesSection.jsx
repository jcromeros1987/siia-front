...
export const PublicacionesSection = ({ perfil = {} }) => {
  return (
      ...
      <div className="p-6">
        ...
        <div className="space-y-6">
          <div className="border-b border-gray-100 pb-6 last:border-b-0 last:pb-0">
            ...
            <IdentificadoresTab
              firmas={perfil.firmas}
              scopusIds={perfil.scopus_ids}
              orcid={perfil.orcid}
            />
          </div>
          ...
          <div className="border-b border-gray-100 pb-6 last:border-b-0 last:pb-0">
            ...
            <CoautoriasTab entidades={perfil.coautorias_entidades_unam} />
          </div>
          ...
          <div className="border-b border-gray-100 pb-6 last:border-b-0 last:pb-0">
            ...
            <RevistasTab revistas={perfil.revistas} />
          </div>
        </div>
      </div>
    </section>
