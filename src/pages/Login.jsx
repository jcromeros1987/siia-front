...
const Login = () => {
  ...
  <div className="min-h-screen flex justify-center items-center relative overflow-hidden">
    <div className="absolute inset-0 bg-base-100 w-full h-3/5"></div>
    <div className="absolute bottom-0 w-full h-2/5 bg-primary"></div>
    ...
    <div className="p-10 z-20 bg-base-300 rounded-lg shadow-2xl/30 max-w-sm md:max-w-lg md:min-w-lg text-center">
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-4">
        <div className="relative">
          ...
          />
          <label htmlFor="email" className={`absolute font-bold text-primary transition-all duration-300
        ...
        <div className="relative">
          ...
          />      
          <label htmlFor="password" className={`absolute font-bold text-primary transition-all duration-300 
